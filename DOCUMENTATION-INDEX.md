...
Historical troubleshooting and fix documents are archived in `archive/` directory:

- Traefik troubleshooting (VLAN access, port fixes, DNS routing)
...
This repository's documentation aligns with:

- **specs-homelab/stacks/infrastructure.md** - Infrastructure stack documentation
- **specs-homelab/stacks/automation.md** - Automation stack (Traefik, Portainer)
- **specs-homelab/reference/common-values.md** - DNS names and IP addresses
- **specs-homelab/standards/dns-naming-convention.md** - DNS naming standards

## Quick Links

- **Current Status**: `SERVICES-STATUS.md`
